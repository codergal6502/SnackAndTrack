...
namespace SnackAndTrack.DatabaseAccess.Seeding {
    public class NutrientSeed {
        ...
        public void DoSeed() {
            ...
            EnsureNutrient("Total Carbohydrates", "Grams",      (Single) 27,   "Macronutrients", displayOrder += 10);
            EnsureNutrient("Dietary Fiber",       "Grams",      (Single) 28,   "Macronutrients", displayOrder += 10);
            EnsureNutrient("Total Sugars",        "Grams",      (Single) 0,    "Macronutrients", displayOrder += 10);
            ...
            EnsureNutrient("Iron",                         "Milligrams", (Single) 0,    "Micronutrients", displayOrder += 10);
            ...
            EnsureNutrient("Magnesium",                    "Milligrams", (Single) 0,    "Micronutrients", displayOrder += 10);
            ...
            EnsureNutrient("Manganese",                    "Milligrams", (Single) 0,    "Micronutrients", displayOrder += 10);
            ...
            EnsureNutrient("Iodine",                       "Micrograms", (Single) 0,    "Micronutrients", displayOrder += 10);
